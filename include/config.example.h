...
#define NANOBMC_NO_CLIENT_DELAY_MS 250
#define NANOBMC_CONNECTED_IDLE_DELAY_MS 50
#define NANOBMC_SERIAL_ACTIVE_DELAY_MS 5
#define NANOBMC_SERIAL_RECENT_ACTIVITY_MS 100
#define NANOBMC_IDLE_DELAY_MS NANOBMC_NO_CLIENT_DELAY_MS
#define NANOBMC_ACTIVE_DELAY_MS NANOBMC_SERIAL_ACTIVE_DELAY_MS
#define NANOBMC_IDLE_LIGHT_SLEEP_ENABLED false
#define NANOBMC_IDLE_LIGHT_SLEEP_MS NANOBMC_NO_CLIENT_DELAY_MS
